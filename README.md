...
This was an learning project, built before the [STM32 self-balancing robot](https://github.com/Boren-Z/stm32-balance-car-ola) — it's where the motor control and cascade-PID fundamentals used in that later project were first worked out.
